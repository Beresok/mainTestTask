			...
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
				<tr>
					<td>
						...
						<? if (in_array($propertyID, $arResult["ERRORS_ID"])) { ?>
							<? if ($arResult["PROPERTY_LIST_FULL"][$propertyID]['IS_REQUIRED'] == 'Y') { ?><span style="color:red;" class="starrequired">* <br>(<?=$arResult["ERRORS"][$propertyID]?>)</span><? } ?></td>
						<? } else { ?>
							<? if ($arResult["PROPERTY_LIST_FULL"][$propertyID]['IS_REQUIRED'] == 'Y') { ?><span class="starrequired">*</span><? } ?></td>
						<? } ?> 
					...
					<td>
						...
						switch ($INPUT_TYPE):
							...
							case "USER_TYPE":
								...
								{
									if ($_REQUEST['PROPERTY'][$propertyID]) {
										$value = $_REQUEST['PROPERTY'][$propertyID][0]['VALUE']['TEXT']; 
									} 
									elseif ($i == 0)
									{
						...
						<input type="file" 
								...
								name="PROPERTY_FILE_<?=$propertyID?>_<?=$arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] ? $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] : $i?>" /><br />
									<?
